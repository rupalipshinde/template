...
//use rupalipshinde\templateWithLocalization\RouteRegistrar;
...
//    public static $authCodeModel = 'Laravel\Passport\AuthCode';
     ...
     * @var string
     */
    public static $templateModel = 'Rupalipshinde\Template\TemplateModel';
     ...
     * @var string
     */
    public static $personalAccessClientModel = '';
...
//    public static $tokenModel = 'Laravel\Passport\Token';
    ...
    public static function routes($callback = null, array $options = [])
    {
        ...
        $defaultOptions = [
            'prefix' => 'oauth',
            'namespace' => '\rupalipshinde\templateWithLocalization\Http\Controllers',
        ];
...
//                'uses' => 'TemplateController@forTemplate',
...
//        });
     ...
     * @return void
     */
    public static function useTemplateModel($templateModel)
    {
     ...
     * @return string
     */
    public static function templateModel()
    {
    ...
    {
        return new static::$templateModel;
    }
