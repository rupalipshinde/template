...
Route::get('/get-template-using-language/{language}', ['as' => 'get-template-using-language','uses'=>'\Rupalipshinde\Template\Http\Controllers\TemplateController@findTemplateUsingLanguage']);
